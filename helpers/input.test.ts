...
describe("Input Helpers", () => {
	...
	describe("readPuzzleInputPreservingWhiteLines", () => {
		it("should read the file from the specified location", async () => {
			const filePath = "/some/absolute/path/abc";
			const fileName = "../some-file-name.txt";
			const expectedURI = path.normalize("/some/absolute/path/some-file-name.txt");

			await readPuzzleInputPreservingWhiteLines(filePath, fileName);
